...
import Pishloq from "../assets/Tomato.png";
    ...
    <div style={{ display: "flex" }}>
      <div style={{ flex: 1, padding: 40 }}>
        <div style={{ maxHeight: 500, maxWidth: 500, position: "relative" }}>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{
              y: ingredients["Sishloq"] ? 100 : -100,
              opacity: ingredients["Sishloq"] ? 1 : 0,
            }}
            transition={{ duration: 1 }}
            className="ingredients z4"
          >
            <img src={Pishloq} alt="Sishloq" height="100%" width="100%" />
          </motion.div>
          <motion.div
            initial={{ scale: 0 }}
            animate={{
      ...
      <div style={{ flex: 1, padding: 40 }}>
        ...
        <label className="container-checkbox">
          ...
          <input
            type="checkbox"
            checked={ingredients["Sishloq"]}
            onChange={(event) =>
              onChange(event.currentTarget.checked, "Sishloq")
            }
          />
          <span className="checkmark"></span>
        </label>
